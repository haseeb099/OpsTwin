...
# Copy this and fill in the blanks when starting a task with ANY coding agent
# (Cursor, Claude Code, Gemini, GitHub Copilot, Codex, Windsurf, Cline, Gravity, etc.)
...
AUDIT REQUIREMENT:
  ...
  Set "agent" to your tool name in the JSON.
